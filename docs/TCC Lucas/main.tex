...
Como discutido na Seção 5, a principal limitação desta fase é a natureza preliminar da validação por agentes de IA, que não substitui a experiência de usuários reais. Por isso, como trabalho futuro, planeja-se a execução de testes empíricos com grupos representativos de participantes (pessoas com deficiência visual e educadores). Além disso, a expansão contínua da base de dados catalogada e o aprimoramento das heurísticas de recomendação constituem os próximos passos para consolidar o \textit{IncluiDev} como uma ferramenta de referência no ecossistema de educação inclusiva.
